...
The copy-ready controller, Cloud/source, staging identity, lecture UX/AI,
reliability and independent-review prompts are in
[`LECTURE_CYCLE_CLOUD_AGENT_PLAYBOOK.md`](LECTURE_CYCLE_CLOUD_AGENT_PLAYBOOK.md).
Write-capable lanes always use separate branches/worktrees. The controller
