...
## 5. What the 110 `test:*` scripts actually divide into

| Count | Kind                               | Where it runs                                                                                                                                                                                         |
| ----: | ---------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|    72 | in `safeTestScripts`               | automatically inside `npm run test:ci:nonlive`; no need to invoke individually                                                                                                                        |
...
|    10 | demo browser                       | CI's `demo-e2e` job: `test:e2e:demo:triple`, Phase 7.26/7.27/7.29/7.30 flag-ON and flag-OFF suites                                                                                                    |
