...
| `lint`                                             | yes                             | yes                                                         |
| `test:ci:nonlive` (68 groups)                      | yes                             | yes                                                         |
...
npm run test:phase7-30-upgrade          # populated 7.29/B1/B2/B2.2a-head data through 7.30B2.2b
...
| ----: | ---------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|    68 | in `safeTestScripts`               | automatically inside `npm run test:ci:nonlive`; no need to invoke individually                                                                                                                        |
