...
SELECT is(pg_temp.exercise_presenter($mutation$UPDATE private.admin_environment_memberships SET status = 'suspended' WHERE id = '00000000-0000-4000-8000-00000000e506'$mutation$)
  - 'nonce_count' - 'new_events' - 'state_before_machine',
  '{"page_accepted":false,"heartbeat_active":false,"page":1,"state":"revoked","reason":"admin_revoked","last_sequence":-1}'::jsonb,
  'membership suspended: page cannot advance and capability is terminal');
SELECT is(pg_temp.exercise_presenter($mutation$UPDATE private.admin_environment_memberships SET status = 'suspended' WHERE id = '00000000-0000-4000-8000-00000000e506'$mutation$, 'heartbeat')
  ->> 'heartbeat_active', 'false',
