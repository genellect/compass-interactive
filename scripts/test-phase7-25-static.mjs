...
assert.match(summaryEndpoint, /PHASE7_25_AUTO_ACADEMIC_ANSWERS_ENABLED/)
assert.match(summaryEndpoint, /manage_google_admin_summary_run_v2/)
assert.match(generate, /action === 'generateAuto'/)
assert.match(generate, /prepare_google_admin_academic_answer_v1/)
assert.match(generate, /start_google_admin_academic_answer_operation_v1/)
assert.match(generate, /manage_google_admin_academic_results_v1/)
...
assert.match(summaryControl, /academicRequestIdsRef/)
assert.match(summaryControl, /grantRequestId: crypto\.randomUUID\(\)/)
