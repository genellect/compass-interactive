...
assert.match(endpoint, /PHASE7_2_ACADEMIC_ANSWERS_ENABLED/)
assert.match(endpoint, /hasLegacyAdminFields\(body\)/)
assert.match(endpoint, /prepare_google_admin_academic_answer_v1/)
assert.match(endpoint, /issue_google_academic_answer_ai_child_grant_v1/)
assert.match(endpoint, /start_google_admin_academic_answer_operation_v1/)
assert.match(endpoint, /claim_google_ai_provider_dispatch_v1/)
assert.match(endpoint, /complete_google_admin_academic_answer_operation_v1/)
assert.match(endpoint, /manage_google_admin_academic_results_v1/)
assert.match(endpoint, /reap_stale_google_ai_provider_dispatches_v1/)
...
assert.doesNotMatch(adminPanel, /API PIN/)
assert.match(adminPanel, /個人AI PINは不要/)
