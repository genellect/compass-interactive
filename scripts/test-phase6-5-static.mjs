...
const [
  ...
  read(
    'supabase/migrations/20260716062858_phase6_5_optional_comment_nicknames.sql',
  ),
...
assert.doesNotMatch(
  commentRepository,
  /\.update\(|\.channel\(|postgres_changes/,
)
assert.match(
  liveRepository + liveStateMappers,
